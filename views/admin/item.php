          ...
          <div class="row">
            <div class="col-9">
              <table class="table">
                ...
                <tbody>
                  <?php
                  $showAllItem = new Item();
                  $showItem = $showAllItem->showAllItem();

                  if ($showItem) {
                    $i=0;
                    while ($result = $showItem->fetch_assoc())
                    {
                      $i++;
                  ?>
                  ...
                  <?php
                    ...
                    if(isset($_GET['dele_id']))
                    {
                        ...
                        $deleteItem = $itemDelete->deleteItem($id);
                    }
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="itemEdit.php?item_id=<?php echo $result['item_id']?>">
                        <button class="btn btn-success">Edit</button>
                      </a>
                      <a href="?dele_id=<?php echo $result['item_id']?>"
            ...
            <div class="col-3">
              ...
              if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $insertItem = $item->addItem($_POST, $_FILES);
              }
              ?>
              <!-- Form thêm sản phẩm -->
              <form action="" method="post" enctype="multipart/form-data" role="form">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select mt-3" aria-label="Default select example" name="cate_id">
                    ...
                    ?>
                        <option value="<?php echo $result['cate_id'] ?>">--<?php echo $result['cateName'] ?>--</option>
                    <?php
                      }
                    }
                    ?>
                  ...
                  <input type="number" class="form-control  mt-3" name="price">
